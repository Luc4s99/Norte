...
import { Wrapper, Image, Title, Texto, Box } from './styles.js';
            ...
            <Wrapper>
                ...
                <Texto>
                    ...
                    <Box>
                        ...
                        <Link to='/login'><button type="button" class="btn btn-success">Realizar Login</button></Link>
                        <br/>
                        <br/>
                        <Link to='/cadastro'><button type="button" class="btn btn-success">Realizar Cadastro</button></Link>
